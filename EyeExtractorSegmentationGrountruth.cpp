...
const int EyeExtractorSegmentationGrountruth::eyeDX = 32;
const int EyeExtractorSegmentationGrountruth::eyeDY = 16;
const cv::Size EyeExtractorSegmentationGrountruth::eyeSize = cv::Size(eyeDX * 2, eyeDY * 2);

EyeExtractorSegmentationGrountruth::EyeExtractorSegmentationGrountruth():
...
void EyeExtractorSegmentationGrountruth::process() {
...
bool EyeExtractorSegmentationGrountruth::isBlinking() {
	return _isBlinking;
}

void EyeExtractorSegmentationGrountruth::extractEye(cv::Mat originalImage) {
...
void EyeExtractorSegmentationGrountruth::extractEyeLeft(cv::Mat originalImage) {
...
void EyeExtractorSegmentationGrountruth::draw() {
	if (!Application::Components::pointTracker->isTrackingSuccessful())
		return;
...
void EyeExtractorSegmentationGrountruth::start() {
	pointStart();
}

// When a new calibration point is starting, prepare the average eye accumulators
void EyeExtractorSegmentationGrountruth::pointStart() {
	averageEye.reset(new FeatureDetector(EyeExtractorSegmentationGrountruth::eyeSize));
	averageEyeLeft.reset(new FeatureDetector(EyeExtractorSegmentationGrountruth::eyeSize));
}

void EyeExtractorSegmentationGrountruth::pointEnd() {}
void EyeExtractorSegmentationGrountruth::abortCalibration() {}
void EyeExtractorSegmentationGrountruth::calibrationEnded() {}

bool EyeExtractorSegmentationGrountruth::hasValidSample() {
