...
*/
		...
		// MIXED ESTIMATION
		std::cout << "Drawing regular GazeTracker output" << std::endl;

		//Utils::mapToVideoCoordinates(Application::Data::gazePointGP, Application::Components::videoInput->getResolution(), estimation);
		cv::circle(image, 
			Utils::mapFromMainScreenToDebugCoordinates(cv::Point((Application::Data::gazePointGP.x + Application::Data::gazePointGPLeft.x) / 2, (Application::Data::gazePointGP.y + Application::Data::gazePointGPLeft.y) / 2)), 
			8, cv::Scalar(0, 255, 0), -1, 8, 0);
