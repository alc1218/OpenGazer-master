...
#define SegmentationVideoFlag 1
...
void ExtractEyeFeaturesSegmentation::processToExtractFeatures() {
	...
	for(int side = 0; side < 2; side++) {
		...
		if (SegmentationVideoFlag == 1) {
			...
			cv::Mat *imageSegmentationVideo = (side == 0) ? Application::Components::eyeExtractorSegmentationGrountruth->eyeImage.get() : Application::Components::eyeExtractorSegmentationGrountruth->eyeImageLeft.get();
